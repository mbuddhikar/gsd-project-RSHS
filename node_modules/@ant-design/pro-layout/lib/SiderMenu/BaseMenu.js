...
var MenuUtil = function MenuUtil(props) {
  ...
  this.hasChildren = function (item) {
    return item && !item.hideChildrenInMenu && (item === null || item === void 0 ? void 0 : item.children) && item.children.some(function (child) {
  ...
  this.getSubMenuOrItem = function (item, isChildren) {
    if (Array.isArray(item.children) && _this.hasChildren(item)) {
      ...
      }, !isChildren && getIcon(item.icon), /*#__PURE__*/_react.default.createElement("span", null, name)) : /*#__PURE__*/_react.default.createElement("span", {
        className: "".concat(prefixCls, "-menu-item")
  ...
  this.getMenuItemPath = function (item, isChildren) {
    ...
    if (isHttpUrl) {
      defaultItem = /*#__PURE__*/_react.default.createElement("a", {
        href: itemPath,
        target: target
      }, icon, /*#__PURE__*/_react.default.createElement("span", null, name));
    }
...
var BaseMenu = function BaseMenu(props) {
  ...
  var _useState3 = (0, _react.useState)(function () {
    return new MenuUtil(props);
      ...
      menuUtils = _useState4[0]; // sync props
