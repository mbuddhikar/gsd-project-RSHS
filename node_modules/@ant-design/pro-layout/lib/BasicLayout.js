...
var renderSiderMenu = function renderSiderMenu(props, matchMenuKeys) {
  ...
  if (menuData && ((_menuData = menuData) === null || _menuData === void 0 ? void 0 : _menuData.length) < 1 && splitMenus) {
    return null;
  }
  ...
  if (menuRender) {
    return menuRender(props, /*#__PURE__*/_react.default.createElement(_SiderMenu.default, _extends({
      matchMenuKeys: matchMenuKeys
    }, props)));
  }
...
var getPaddingLeft = function getPaddingLeft(hasLeftPadding, collapsed) {
  var siderWidth = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 208;
...
var BasicLayout = function BasicLayout(props) {
  ...
  if (menuDataRender) {
    renderMenuInfoData = (0, _getMenuData.default)((route === null || route === void 0 ? void 0 : route.routes) || [], menu, formatMessage, menuDataRender);
  }
  ...
  var matchMenus = (0, _routeUtils.getMatchMenu)(location.pathname || '/', menuData);
  ...
  var _useMergedState3 = (0, _useMergedState5.default)(defaultCollapsed || false, {
  ...
  var defaultProps = (0, _omit.default)(_objectSpread(_objectSpread(_objectSpread({}, props), currentMenuLayoutProps), {}, {
  ...
  return /*#__PURE__*/_react.default.createElement(_Counter.default.Provider, null, /*#__PURE__*/_react.default.createElement(_RouteContext.default.Provider, {
    ...
    hasSider: true
  }, siderMenuDom, /*#__PURE__*/_react.default.createElement(_layout.default, {
