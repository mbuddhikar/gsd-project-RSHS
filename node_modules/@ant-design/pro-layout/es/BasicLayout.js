...
var renderSiderMenu = function renderSiderMenu(props, matchMenuKeys) {
  ...
  if (menuRender) {
    return menuRender(props, /*#__PURE__*/React.createElement(SiderMenu, _extends({
      matchMenuKeys: matchMenuKeys
    }, props)));
  }
...
var BasicLayout = function BasicLayout(props) {
  ...
  if (menuDataRender) {
    renderMenuInfoData = getMenuData((route === null || route === void 0 ? void 0 : route.routes) || [], menu, formatMessage, menuDataRender);
  }
  ...
  var matchMenus = getMatchMenu(location.pathname || '/', menuData);
  ...
  var _useMergedState3 = useMergedState(defaultCollapsed || false, {
  ...
  var defaultProps = Omit(_objectSpread(_objectSpread(_objectSpread({}, props), currentMenuLayoutProps), {}, {
