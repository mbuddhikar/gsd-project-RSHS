...
var HeaderMenu = function HeaderMenu(props) {
  ...
  if (type === 'inline') {
    return /*#__PURE__*/_react.default.createElement("div", {
      className: (0, _classnames.default)("".concat(prefixCls, "-menu"), "".concat(prefixCls, "-inlinemenu"))
      ...
      return /*#__PURE__*/_react.default.createElement("div", {
        ...
        className: (0, _classnames.default)("".concat(prefixCls, "-inlinemenu-item"), activeItem.key === item.key ? "".concat(prefixCls, "-inlinemenu-item-active") : undefined)
      }, item.label);
    }));
  }
  ...
  }, activeItem.label, /*#__PURE__*/_react.default.createElement(_icons.DownOutlined, {
    style: {
      fontSize: 14,
      marginLeft: 4
    }
