...
var FieldLabel = function FieldLabel(props) {
  ...
  return /*#__PURE__*/_react.default.createElement("span", {
    className: (0, _classnames.default)(prefixCls, "".concat(prefixCls, "-").concat(size), (_classNames = {}, _defineProperty(_classNames, "".concat(prefixCls, "-active"), !!value), _defineProperty(_classNames, "".concat(prefixCls, "-disabled"), disabled), _defineProperty(_classNames, "".concat(prefixCls, "-bordered"), bordered), _classNames), className),
    style: style
  }, getTextByValue(label, value), value && /*#__PURE__*/_react.default.createElement(_icons.CloseOutlined, {
